 ...
 */
var SolidityFunction = function (json, address, pipe) {
...
SolidityFunction.prototype.toPayload = function (args, options) {
    ...
    opts.data = '0x' + this.signature() + coder.encodeParams(this._inputTypes, args);
    return opts;
};
...
SolidityFunction.prototype.sendTransaction = function () {
    ...
    var callback = this.extractCallback(args);
    var payload = this.toPayload(args);
    this._pipe.transact(payload, callback);
};
 ...
 * @property {string} from - An identifier of the caller.
