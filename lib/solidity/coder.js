 ...
 * @method isArrayType
 * @param {String} type
 * @return {Boolean} true is the type is an array, otherwise false
 */
 ...
 * @method isType
 * @param {String} name
 * @return {Boolean} true if type match this SolidityType, otherwise false
 */
 ...
 * @param {Boolean} arrayType - true if a param should be encoded as an array
 ...
 *
 * @method formatOutput
 * @param {SolidityParam} param - byteArray
 * @param {Boolean} arrayType - true if a param should be decoded as an array
