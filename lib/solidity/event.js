...
SolidityEvent.prototype.signature = function () {
    return sha3(this._name).toUpperCase();
};
 ...
 *
 * @method execute
 * @param {function} [startCallback] - error-first callback. The data object is the EventSub. If left out, you will
 * receive events but won't be able to shut the subscription down.
...
SolidityEvent.prototype.execute = function (startCallback, eventCallback) {
    if(arguments.length === 1){
        ...
        startCallback = function(error, data){
            if(error){
                eventCallback(error);
            }
        }
...
SolidityEvent.prototype.attachToContract = function (contract) {
    ...
    execute.once = function(eventCallback){
        var eventSub;
        execute(function(error, sub){
            if(error){
                eventCallback(error);
            } else {
                eventSub = sub;
