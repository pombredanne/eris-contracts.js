 ...
 * @returns {SolidityParam} result of combination
 */
 ...
 *
 * @method encodeList
 * @param {SolidityParam[]} params - the parameters.
 * @returns {String}
 */
...
SolidityParam.decodeArray = function (bytes, index) {
    index = index || 0;
    var offset = getOffset(bytes, index);
    var length = parseInt(bytes.substr(offset * 2, 64), 16);
