...
var addFunctionsToContract = function (contract) {
    contract.abi.filter(function (json) {
        ...
        // Add formatter, or if no formatter exists just
        var of = outputFormatter || function(json, output){return output};
        return new SolidityFunction(json, contract.address, contract.pipe, contract.outputFormatter);
    }).forEach(function (f) {
...
var addEventsToContract = function (contract) {
    contract.abi.filter(function (json) {
        ...
        return new SolidityEvent(json, contract.address, contract.pipe);
    }).forEach(function (e) {
