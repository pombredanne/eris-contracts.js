 ...
 * @param {Array} abi
 */
var addFunctionsToContract = function (contract, abi, pipe) {
    abi.filter(function (json) {
        return json.type === 'function';
    }).map(function (json) {
        return new SolidityFunction(json, contract.address, pipe);
    }).forEach(function (f) {
 ...
 * @param {Array} abi
 */
var addEventsToContract = function (contract, abi, pipe) {
    abi.filter(function (json) {
...
ContractFactory.prototype.at = function (address, callback) {
    callback(null, new Contract(this.abi, address, this._pipe));
};
 ...
 * @param {pipe} pipe;
 */
var Contract = function (abi, address, pipe) {
    this.address = address;
    this.abi = abi;
    this._pipe = pipe;
    addFunctionsToContract(this, abi, pipe);
    addEventsToContract(this, abi, pipe);
};
